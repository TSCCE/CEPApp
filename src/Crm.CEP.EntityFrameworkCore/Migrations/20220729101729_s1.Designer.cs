...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Crm.CEP.Customers.Customer", b =>
                {
                    ...
                    b.Property<string>("LoyaltyExpiryDate")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Crm.CEP.Passwords.Password", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("SaltKeyID")
                        .HasColumnType("bigint");

                    b.HasKey("Id");

                    b.HasIndex("SaltKeyID")
                        .IsUnique();
            ...
            modelBuilder.Entity("Crm.CEP.Queries.Query", b =>
                {
                    ...
                    b.Property<string>("JSONQueryField")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Crm.CEP.SaltKeys.SaltKey", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("SaltKeyvalue")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.ToTable("AppSaltKeys", (string)null);
                });
            ...
            modelBuilder.Entity("Crm.CEP.Segments.Segment", b =>
                {
                    ...
                    b.ToTable("AppSegments", (string)null);
                });

            modelBuilder.Entity("Crm.CEP.Settings.Setting", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Crm.CEP.Transactions.Transaction", b =>
                {
                    ...
                    b.Property<string>("StoreIDOfTransaction")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Crm.CEP.TransactionsItems.TransactionItem", b =>
                {
                    b.Property<string>("ItemID")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Crm.CEP.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Crm.CEP.CustomerCoupons.CustomerCoupon", b =>
                {
                    ...
                    b.HasOne("Crm.CEP.Customers.Customer", "Customer")
                        .WithMany("CustomerCoupons")
            ...
            modelBuilder.Entity("Crm.CEP.Passwords.Password", b =>
                {
                    b.HasOne("Crm.CEP.SaltKeys.SaltKey", "SaltKey")
                        .WithOne("password")
                        .HasForeignKey("Crm.CEP.Passwords.Password", "SaltKeyID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SaltKey");
                });

            modelBuilder.Entity("Crm.CEP.Queries.Query", b =>
                {
                    b.HasOne("Crm.CEP.Segments.Segment", "Segment")
                        .WithOne("Query")
                        .HasForeignKey("Crm.CEP.Queries.Query", "SegmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Crm.CEP.Settings.Setting", b =>
                {
                    b.HasOne("Crm.CEP.Passwords.Password", "Password")
                        .WithOne("Setting")
                        .HasForeignKey("Crm.CEP.Settings.Setting", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Crm.CEP.TransactionsItems.TransactionItem", b =>
                {
                    b.HasOne("Crm.CEP.Items.Item", "Item")
                        .WithMany("TransactionItems")
                        .HasForeignKey("ItemID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Crm.CEP.Transactions.Transaction", "Transaction")
                        .WithMany("TransactionItems")
