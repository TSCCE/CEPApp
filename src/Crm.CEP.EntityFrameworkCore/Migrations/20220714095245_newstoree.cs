...
{
    public partial class newstoree : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppTransactions", x => x.TransactionId);
                    table.ForeignKey(
                        name: "FK_AppTransactions_AppCustomers_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    JSONQueryField = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppQuerys", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppQuerys_AppSegments_SegmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TransactionItems", x => new { x.ItemID, x.TransactionID });
                    table.ForeignKey(
                        name: "FK_TransactionItems_AppItems_ItemID",
                        column: x => x.ItemID,
                        principalTable: "AppItems",
                        principalColumn: "ItemID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TransactionItems_AppTransactions_TransactionID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppTransactions_CustomerId",
